...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta name="html-safe-nonce" content="5f09c0258c087b686a461315e8cd411fb0836e72">

  <meta http-equiv="x-pjax-version" content="10c80ea533591cecc9bf0d03e9bbdc45">
  

      <link href="https://github.com/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/commits/615b977d33424fb289e6024d65bdba2945c8c627.atom" rel="alternate" title="Recent Commits to IISc_Proficience_DAF_Jan-May-2018_Project3:615b977d33424fb289e6024d65bdba2945c8c627" type="application/atom+xml">

  <meta name="description" content="IISc_Proficience_DAF_Jan-May-2018_Project3 - This repository contains the &quot;Data Preparation&quot; part of the whole project.">
  <meta name="go-import" content="github.com/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3 git https://github.com/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3.git">
...
<link rel="manifest" href="/manifest.json" crossOrigin="use-credentials">
  ...
  <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/A25C3781-AE37-614C-98E6-69AECFBF5268/main.js" charset="UTF-8"></script></head>
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:11418035" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@avvarimanju" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/11418035?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">avvarimanju</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/avvarimanju" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/avvarimanju?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
  ...
  <li>
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="b9a/mWXA+gDDh+bJ8eFFSHE4OS3GAOXijO/YeVBPCS2t5S1Nr5/LmZAw+D0KsSbHfa335O5dOz6eSAYCEUwL1w==" />
      ...
      <button
        ...
        aria-label="Unstar this repository" title="Unstar BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3"
        data-ga-click="Repository, click unstar button, action:blob#show; text:Unstar">
        <svg class="octicon octicon-star" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/></svg>
        Unstar
      </button>
        <a class="social-count js-social-count" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/stargazers"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="f1n6zuNLvoTPyFPByDal3SFMpe9cbNTApcSdRswIpqKYYqbEUMHbammkmIU5fM8u8FHhGhl4Kqrc0h3AJZT+jg==" />
      ...
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3"
  ...
  <li>
          <a href="#fork-destination-box" class="btn btn-sm btn-with-count"
              title="Fork your own copy of BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3 to your account"
              aria-label="Fork your own copy of BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3 to your account"
              rel="facebox"
          ...
          <div id="fork-destination-box" style="display: none;">
            ...
            <include-fragment src=""
                ...
                data-url="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/fork?fragment=1">
              <img alt="Loading" src="https://assets-cdn.github.com/images/spinners/octocat-spinner-128.gif" width="64" height="64" />
            </include-fragment>
          </div>

    <a href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/network" class="social-count"
      ...
      <h1 class="public ">
  <svg class="octicon octicon-repo-forked" viewBox="0 0 10 16" version="1.1" width="10" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"/></svg>
  <span class="author" itemprop="author"><a class="url fn" rel="author" href="/BhupalReddyP">BhupalReddyP</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a data-pjax="#js-repo-pjax-container" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3">IISc_Proficience_DAF_Jan-May-2018_Project3</a></strong>

    <span class="fork-flag">
      <span class="text">forked from <a href="/avvarimanju/IISc_Proficience_DAF_Jan-May-2018_Project3">avvarimanju/IISc_Proficience_DAF_Jan-May-2018_Project3</a></span>
    </span>
</h1>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a data-hotkey="g p" itemprop="url" class="js-selected-navigation-item reponav-item" data-selected-links="repo_pulls checks /BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/pulls" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/pulls">
    ...
    <a data-hotkey="g b" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/projects" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/projects">
      <svg class="octicon octicon-project" viewBox="0 0 15 16" version="1.1" width="15" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/wiki" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/wiki">
      <svg class="octicon octicon-book" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>

  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/pulse" href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/pulse">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  <button class=" btn btn-sm select-menu-button js-menu-target css-truncate" data-hotkey="w"
    ...
    type="button" aria-label="Switch branches or tags" aria-expanded="false" aria-haspopup="true">
      <i>Tree:</i>
      <span class="js-select-button css-truncate-target">615b977d33</span>
  </button>
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="BtnGroup float-right">
      <a href="/BhupalReddyP/IISc_Proficience_DAF_Jan-May-2018_Project3/find/615b977d33424fb289e6024d65bdba2945c8c627"
